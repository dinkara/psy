...
class CertificateExists extends DinkoApiExistsMiddleware
{ 
       
    
    /**
     * Create a new Certificate Middleware instance.
     *
     * @return void
     */
     ...
     * @return mixed
     */
    public function handle($request, Closure $next, $key = 'certificate_id', $isForeign = false)
    {                        
        $this->id = $request->id;
