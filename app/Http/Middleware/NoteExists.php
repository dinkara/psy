...
class NoteExists extends DinkoApiExistsMiddleware
{ 
       
    
    /**
     * Create a new Note Middleware instance.
     *
     * @return void
     */
     ...
     * @return mixed
     */
    public function handle($request, Closure $next, $key = 'note_id', $isForeign = false)
    {                        
        $this->id = $request->id;
